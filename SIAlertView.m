...
//    self.containerView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"LoginBG"]];
    
    self.containerView.backgroundColor = [UIColor colorWithRed:55.0f/255.0f green:147.0f/255.0f blue:172.0f/255.0f alpha:1.0];
...
//			highlightedImage = [UIImage imageNamed:@"SIAlertView.bundle/button-cancel-d"];
            ...
            [button setBackgroundColor: [UIColor colorWithRed:204.0f/255.0f green:220.0f/255.0f blue:113.0f/255.0f alpha:1.0]];
...
/*
 ...
 3.
 #define CONTAINER_WIDTH 300 (to 270 on top)
